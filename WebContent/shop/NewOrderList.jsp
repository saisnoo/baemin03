	...
	<div class="w3-card w3-padding">
		...
		<div class="w3-row">
			...
			<div class="w3-col w3-container w3-right"
				...
				if(dto.getStatus()==0){
				%>
				<button class="w3-button w3-blue h100" onclick="jumunBtn(this)">주문버튼</button>
				<%
				}else if(dto.getStatus()==1){
				%>
				<button class="w3-button w3-blue h100" onclick="baesongBtn(this)">버튼</button>
				<% 
				}//else end
				%>
			...
			<div class="w3-rest w3-container">
				<div class="w3-row">
					...
					<div class="w3-col"><%=dto.getNo() %>주문번호 5번</div>
				</div>
				<div class="w3-row"><%=dto.getAddr() %>서울시 구로구 구로5동<%=dto.getAddr2() %>경영기술개발원</div>
			</div>
			<!-- 가운데 끝 -->
		</div>
		<!-- 상단 컨테이너 끝 -->
		<!-- 하단 컨테이너 -->
		<div>
			<div class="w3-row w3-padding"><%=dto.getOrderList() %>김치찌개 2 / 된장찌개 2 / 후라이드치킨 2 /
